    ...
    <div className="min-h-screen bg-[#f5f5f0] flex items-center justify-center p-4">
      <div className="brut-card max-w-md w-full p-8 border-4">
        <div className="flex justify-center mb-8">
          <div className="bg-[#FFD60A] border-4 border-black p-2">
            <FileBadge className="w-8 h-8" />
          </div>
        </div>
        <h2 className="text-3xl font-black uppercase text-center mb-6">Sign In</h2>
        {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="brut-btn brut-btn-yellow w-full mt-6 py-3 text-lg border-2 border-black">
              Login
            </button>
          </form>
          <p className="text-center mt-6 font-medium">
            Don't have an account?{" "}
            <Link href="/register" className="font-bold underline decoration-2 decoration-cyan-400 underline-offset-4">
              Register
            </Link>
          </p>
        </div>
